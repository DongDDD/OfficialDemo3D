...
- (void)initMapView
{
    ...
    [self.onlyMapView addSubview:self.mapView];
}
...
- (void)viewDidLoad
{
    ...
    self.onlyMapView=[[UIView alloc] initWithFrame:CGRectMake(0, self.view.bounds.size.height*0.3-50, self.view.bounds.size.width, self.view.bounds.size.height*0.7
                                                              )];
